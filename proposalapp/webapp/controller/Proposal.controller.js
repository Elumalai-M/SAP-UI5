  ...
  function (
    ...
    return Controller.extend("proposalapp.controller.Template", {
      ...
      getProductType: function () {
        ...
        jQuery.ajax({
          url: "http://localhost:8080/odata/v4/ProposalService/PS_VENDOR_ORG_CONTACT?$expand=PS_VENDOR_ORG",
          method: "GET",
          cache: false,
          headers: {
            Authorization: auth, // add Authorization header
        ...
        jQuery.ajax({
          url: "http://localhost:8080/odata/v4/ProposalService/PS_CUSTOMER_ORG",
          method: "GET",
          cache: false,
          headers: {
            Authorization: auth, // add Authorization header
      ...
      createTemplate1: function () {
        ...
        var auth = "Basic " + btoa(username + ":" + password);
        jQuery.ajax({
          url: "http://localhost:8080/odata/v4/ProposalService/PS_TEMPLATE",
          method: "GET",
          cache: false,
          headers: {
            Authorization: auth, // add Authorization header
